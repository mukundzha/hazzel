...
MODEL_CATALOG = [
    {"display_name": "Llama 3.1 8B Enterprise", "id": "llama-3.1-8b-instant", "provider": "groq", "provider_display": "Groq"},
    {"display_name": "Llama 3.3 70B Enterprise", "id": "llama-3.3-70b-versatile", "provider": "groq", "provider_display": "Groq"},
    ...
    {"display_name": "Compound", "id": "groq/compound", "provider": "groq", "provider_display": "Groq"},
    {"display_name": "Compound Mini", "id": "groq/compound-mini", "provider": "groq", "provider_display": "Groq"},
    ...
    {"display_name": "DeepSeek V4.1 Flash", "id": "deepseek-flash", "provider": "deepseek", "provider_display": "DeepSeek"},
    {"display_name": "DeepSeek V4.1 Flash", "id": "deepseek/deepseek-v4.1-flash", "provider": "openrouter", "provider_display": "OpenRouter"},
    {"display_name": "GPT-6 Astra", "id": "openai/gpt-6-astra", "provider": "openrouter", "provider_display": "OpenRouter"},
    {"display_name": "GPT-6 Astra Pro", "id": "openai/gpt-6-astra-pro", "provider": "openrouter", "provider_display": "OpenRouter"},
    {"display_name": "Nex-N2.5-Mini (free)", "id": "nex-agi/nex-n2.5-mini", "provider": "openrouter", "provider_display": "OpenRouter"},
    {"display_name": "Nex-N2.5-Pro (free)", "id": "nex-agi/nex-n2.5-pro", "provider": "openrouter", "provider_display": "OpenRouter"},
    {"display_name": "Qwen3.8 Max (0902)", "id": "qwen/qwen3.8-max-0902", "provider": "openrouter", "provider_display": "OpenRouter"},
    {"display_name": "Muse Spark 1.3", "id": "meta/muse-spark-1.3", "provider": "openrouter", "provider_display": "OpenRouter"},
    {"display_name": "Muse Spark 1.3 Contributor", "id": "meta/muse-spark-1.3-contributor", "provider": "openrouter", "provider_display": "OpenRouter"},
