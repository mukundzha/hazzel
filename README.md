...
- AGENTS.md support: Hazzel reads the repo-level `AGENTS.md` on startup and merges it into the system prompt so repo-specific instructions are always in context.
